...
```typescript
{
  design_score: string      // Оценка визуального стиля (0-10)
  focus_group: string       // Целевая аудитория
...
Проект использует официальный [OpenAI API](https://platform.openai.com/).
